...
// Verificar si el módulo existe antes de hacer patch
let ActivityMenu;
try {
    const module = await import("@hr_attendance/components/systray_attendance/systray_attendance_menu");
    ActivityMenu = module.ActivityMenu;
} catch (error) {
    console.warn("ActivityMenu module not found, skipping patch:", error);
}
