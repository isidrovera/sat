...
class EvaluacionPersonal(models.Model):
    ...
    comunicacion = fields.Selection(string='Comunica clara y efectivamente las ideas tanto oral como por escrito', selection=[('1', 'Muy debajo de las Expectativas'), ('2', 'Debajo de las Expectativas'), ('3', 'Alcanza Expectativas'), ('4', 'Mejora Expectativas'), ('5', 'Sobresaliente')])
    ...
    comunicacion_2 = fields.Selection(string='Usa los canales de comunicación apropiados para promulgar y espacir información e ideas de forma oportuna', selection=[('1', 'Muy debajo de las Expectativas'), ('2', 'Debajo de las Expectativas'), ('3', 'Alcanza Expectativas'), ('4', 'Mejora Expectativas'), ('5', 'Sobresaliente')])
    ...
    relaciones_2 = fields.Selection(string='Prmueve y apoya la diversidad, demuestra respeto por otros, trata de forma justa a todos', selection=[('1', 'Muy debajo de las Expectativas'), ('2', 'Debajo de las Expectativas'), ('3', 'Alcanza Expectativas'), ('4', 'Mejora Expectativas'), ('5', 'Sobresaliente')])
