...
class Reparaciones(models.Model):
    ...
    def _check_contometrok_id(self):
        for record in self:
            if not record.contometrok_id:
    ...
    tapas_id = fields.Selection([('blancas', 'Blancas'), ('amarillas', 'Amarillas'), ('rotas', 'Rotas'), ('le_faltan', 'Le faltan'), ('no_aplica', 'No aplica')],
                                string='Tapas', tracking=True)
    panel_id = fields.Selection([('blanco', 'Blanco'), ('amarillo', 'Amarillo'), ('no_aplica', 'No aplica')],
    ...
    estado_id = fields.Selection([('sin_revisar', 'Sin revisar'), ('para_revision', 'Para revision'), ('asignado', 'Asignado'), ('en_revision', 'En revisión'), ('finalizado', 'Finalizado'), ('con_problemas', 'Con problemas'), ('de_partes', 'De partes'), ('entregada', 'Entregada')],
                                 string='Estado de revisión', related='maquina_id.estado_ventas_id', readonly=False, store=True)
    ...
    toner_black_id = fields.Selection([("nuevo", "Nuevo"), ("regular", "Regular"), ("vacio", "Vacío"), ("sin_botella", "Sin botella")],
                                      string="Toner Black", tracking=True)
    toner_magenta_id = fields.Selection([("nuevo", "Nuevo"), ("regular", "Regular"), ("vacio", "Vacío"), ("sin_botella", "Sin botella"), ("no_aplica", "No aplica")],
                                        string="Toner Magenta", tracking=True)
    toner_cyan_id = fields.Selection([("nuevo", "Nuevo"), ("regular", "Regular"), ("vacio", "Vacío"), ("sin_botella", "Sin botella"), ("no_aplica", "No aplica")],
                                     string="Toner Cyan", tracking=True)
    toner_yellow_id = fields.Selection([("nuevo", "Nuevo"), ("regular", "Regular"), ("vacio", "Vacío"), ("sin_botella", "Sin botella"), ("no_aplica", "No aplica")],
    ...
    impresion_id = fields.Selection([("correcto", "Correcto"), ("sin_probar", "Sin probar"), ("falla", "Falla"), ("no_aplica", "No aplica")],
                                    string="Impresión", tracking=True)
    impresion_usb_id = fields.Selection([("correcto", "Correcto"), ("sin_probar", "Sin probar"), ("falla", "Falla"), ("no_aplica", "No aplica")],
                                        string="Impresión USB", tracking=True)
    scaner_smb_id = fields.Selection([("correcto", "Correcto"), ("sin_probar", "Sin probar"), ("falla", "Falla"), ("no_aplica", "No aplica")],
                                     string="Scanner SMB", tracking=True)
    scaner_usb_id = fields.Selection([("correcto", "Correcto"), ("sin_probar", "Sin probar"), ("falla", "Falla"), ("no_aplica", "No aplica")],
                                     string="Scanner USB", tracking=True)
    scaner_ftp_id = fields.Selection([("correcto", "Correcto"), ("sin_probar", "Sin probar"), ("falla", "Falla"), ("no_aplica", "No aplica")],
                                     string="Scanner FTP", tracking=True)
    scaner_mail_id = fields.Selection([("correcto", "Correcto"), ("sin_probar", "Sin probar"), ("falla", "Falla"), ("no_aplica", "No aplica")],
                                      string="Scanner Mail", tracking=True)
    adf_id = fields.Selection([("sin_revisar", "Sin revisar"), ("mantenimiento", "Mantenimiento"), ("cambio_de_repuestos", "Cambio de repuestos"), ("revisado", "Revisado"), ("no_aplica", "No aplica")],
                              string="ADF", tracking=True)
    tray1_id = fields.Selection([("sin_revisar", "Sin revisar"), ("revisado", "Revisado")],
    ...
    tacho_id = fields.Selection([("si", "Si"), ("no", "No"), ("no_aplica", "No aplica")],
    ...
    rodillo_id = fields.Selection([('requiere_cambio', 'Requiere cambio'), ('nuevo', 'Nuevo'), ('regular', 'Regular'), ('gastada_pero_puede_trabajar', 'Gastada pero puede trabajar'), ("no_aplica", "No aplica")],
                                  string="Rodillo de presión", tracking=True)
    calor_id = fields.Selection([('requiere_cambio', 'Requiere cambio'), ("no_aplica", "No aplica"), ('nuevo', 'Nuevo'), ('regular', 'Regular'), ('gastada_pero_puede_trabajar', 'Gastada pero puede trabajar')],
                                string="Rodillo de calor", tracking=True)
    ...
    optico_id = fields.Selection([("sin_revisar", "Sin revisar"), ("mantenimiento", "Mantenimiento"), ("revisado", "Revisado")],
    ...
    developerc_id = fields.Selection([('requiere_cambio', 'Requiere cambio'), ("no_aplica", "No aplica"), ('nuevo', 'Nuevo'), ('regular', 'Regular'), ('gastada_pero_puede_trabajar', 'Gastada pero puede trabajar')],
    ...
    contometrok_id = fields.Char(string="Contometro", related='maquina_id.contometro', readonly=False, store=True, tracking=True, required=True)
