...
class TonerRequestController(http.Controller):
    ...
    def send_toner_request(self, **post):
        try:
            ...
            <body>
                <div class="header">
                    <h1>🖨️ Nueva Solicitud de Tóner</h1>
                </div>
                
                <div class="content">
                    <div class="client-info">
                        <h2>📋 Información del Cliente</h2>
                        <p>👥 Cliente: <strong>{datos_formulario['cliente']}</strong></p>
                        <p>👤 Solicitante: <strong>{datos_formulario['nombre']}</strong></p>
                        <p>📱 Celular: <strong>{datos_formulario['celular']}</strong></p>
                        <p>💻 Modelo: <strong>{datos_formulario['modelo_maquina']}</strong></p>
                        <p>🔢 Serie: <strong>{datos_formulario['serie']}</strong></p>
                    </div>

                    <div class="counter-box">
                        <div class="counter-item">
                            <h3>⚫ Contador Negro</h3>
                            <strong>{datos_formulario['contometro_black']}</strong>
                        </div>
                        <div class="counter-item">
                            <h3>🎨 Contador Color</h3>
                            <strong>{datos_formulario['contometro_color']}</strong>
                        </div>
                    </div>

                    <h2>📦 Tóners Solicitados</h2>
                    <table>
                        <thead>
                            <tr>
                                <th>Tipo de Tóner</th>
                    ...
                    <p style="margin-top: 30px; text-align: center;">
                        Por favor, proceda con la preparación y envío del tóner.
                    </p>
                </div>
            </body>
            </html>
            ...
            mail_values = {
                'subject': f"🖨️ Solicitud de Tóner - {datos_formulario['modelo_maquina']}",
                'body_html': body_html,
